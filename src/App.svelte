...
<div class="flex h-full w-full flex-col items-center overflow-auto" tabindex="-1">
	<Header on:openmodal={openModalEvent} />

	<main class="mb-6 flex w-full max-w-screen-sm flex-grow flex-col">
		<div class="flex flex-col items-center justify-center md:flex-grow">
			<GameDisplayContainer />
		</div>
		<div
			class="mt-4 flex flex-grow flex-col items-center justify-between px-8"
		...
		>
			...
			{:else}
				<Input />
				<div class="mt-4 w-full px-4" aria-live="assertive">
