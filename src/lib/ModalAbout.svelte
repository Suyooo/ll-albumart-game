...
<div class="flex-col space-y-4">
	...
	<div>
		...
		{#if exported}
			<div class="mt-1 text-xs leading-4 tracking-tighter text-subtle">
				Your save data has been copied to your clipboard.
			</div>
		{/if}
	</div>
	<div class="mt-6 text-xs leading-4 tracking-tighter text-subtle">
		...
		This is a not-for-profit fan project, and unaffiliated with any of the projects or companies above. No challenge to
